...
urlpatterns = [
     ...
     path('global-country-based-news/', GlobalCountryBasedNewsView.as_view(), name='global_country_based_news'),
     path('global-source-based-news/', GlobalSourceBasedNewsView.as_view(), name='global_source_based_news'),
     path('global-keyword-based-news/', GlobalKeywordBasedNewsView.as_view(), name='global_keyword_based_news'),
